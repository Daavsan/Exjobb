...
X_U4            U4(+=N75044 -=N107109 V+=VCC+4 V-=VCC-1 OUT=N38449 ) CN @PWM
...
X_U5            U5(+=0 -=N36794 V+=VCC_ARROW V-=VCC OUT=N36505 ) CN @PWM
+GENERATOR.SCHEMATIC1(sch_1):INS40374@ANLG_DEV.AD8009an/AD.Normal(chips)
X_U6            U6(+=N36490 -=0 V+=VCC_ARROW V-=VCC OUT=N36818 ) CN @PWM
+GENERATOR.SCHEMATIC1(sch_1):INS40508@ANLG_DEV.AD8009an/AD.Normal(chips)
R_R6            R6(1=N604671 2=VCC_ARROW ) CN @PWM GENERATOR.SCHEMATIC1(sch_1):INS60457@ANALOG.R.Normal(chips)
R_R7            R7(1=N604671 2=0 ) CN @PWM GENERATOR.SCHEMATIC1(sch_1):INS60480@ANALOG.R.Normal(chips)
...
V_V8            V8(+=VCC-1 -=0 ) CN @PWM GENERATOR.SCHEMATIC1(sch_1):INS104456@SOURCE.VDC.Normal(chips)
V_V9            V9(+=VCC+4 -=0 ) CN @PWM GENERATOR.SCHEMATIC1(sch_1):INS105596@SOURCE.VDC.Normal(chips)
R_R10           R10(1=N107109 2=N36505 ) CN @PWM GENERATOR.SCHEMATIC1(sch_1):INS107085@ANALOG.R.Normal(chips)
_    _(VCC=VCC)
_    _(VCC+4=VCC+4)
_    _(VCC-1=VCC-1)
